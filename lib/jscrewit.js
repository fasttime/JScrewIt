// JScrewIt 2.15.0 – https://jscrew.it
...
(function () {
    ...
    // novem 0.3.0 – https://github.com/fasttime/novem
    ...
    (function (SolutionType) {
        ...
        SolutionType[SolutionType["NUMERIC"] = 2] = "NUMERIC";
        SolutionType[SolutionType["WEAK_NUMERIC"] = 4] = "WEAK_NUMERIC";
    ...
    var calculateSolutionType = function (replacement) {
        ...
        switch (typeof value) {
            ...
            case 'number':
                {
                    var type = isWeak(replacement, value) ? SolutionType.WEAK_NUMERIC : SolutionType.NUMERIC;
                    return type;
                }
            case 'object':
            case 'function':
    ...
    var isArithmetic = makeIsAttr(SolutionType.UNDEFINED, SolutionType.NUMERIC, SolutionType.WEAK_NUMERIC);
    var isLoose = makeIsAttr(SolutionType.WEAK_NUMERIC, SolutionType.PREFIXED_STRING, SolutionType.WEAK_PREFIXED_STRING, SolutionType.COMBINED_STRING);
    ...
    var isUndefined = makeIsAttr(SolutionType.UNDEFINED);
    var isWeak$1 = makeIsAttr(SolutionType.WEAK_NUMERIC, SolutionType.WEAK_PREFIXED_STRING);
    function makeIsAttr() {
        var types = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            types[_i] = arguments[_i];
    ...
    var RULES = [
        ...
        // NUMERIC, PREFIXED_STRING
        {
            typeSetList: [
                ...
                createTypeSet(SolutionType.UNDEFINED, SolutionType.NUMERIC, SolutionType.PREFIXED_STRING),
            ],
            overhead: 3,
            replace: function (r1, r2) { return "[" + r1 + "]+" + r2; },
            solutionType: SolutionType.COMBINED_STRING,
    ...
    function findRule(elements, mapElementToSolutionType) {
        var returnValue;
    ...
    function matchSolutions(typeSets, elements, mapElementToSolutionType) {
        if (typeSets.length > elements.length)
            return false;
        var test = typeSets.every(function (typeSet, index) {
            var element = elements[index];
            var solutionType = mapElementToSolutionType(element);
            var test = includesType(typeSet, solutionType);
            return test;
        });
        return test;
    }
    ...
    var AbstractSolution = /** @class */ (function () {
        ...
        Object.defineProperty(AbstractSolution.prototype, "isArithmetic", {
            get: function () {
        ...
        Object.defineProperty(AbstractSolution.prototype, "isUndefined", {
            get: function () {
        ...
        Object.defineProperty(DynamicSolution.prototype, "type", {
            get: function () {
                ...
                switch (solutions.length) {
                    ...
                    default:
                        {
                            var solutionType = findRuleBySolutions(solutions).solutionType;
                            return solutionType;
                        }
                }
            },
    ...
    function calculateReplacement(solutions) {
        switch (solutions.length) {
            ...
            default:
                {
                    var _a = findRuleBySolutions(solutions), replace = _a.replace, typeSetList = _a.typeSetList;
                    var typeSetCount = typeSetList.length;
                    var replacements = solutions.slice(0, typeSetCount).map(getReplacement);
                    var appendableReplacements = solutions.slice(typeSetCount).map(getAppendableReplacement);
                    var replacement = __spreadArrays([replace.apply(void 0, replacements)], appendableReplacements).join('');
                    return replacement;
                }
        }
    }
    var findRuleBySolutions = function (solutions) { return findRule(solutions, getType); };
    ...
    var createComplexOptimizer$1 = createComplexOptimizer;
    ...
    (function ()
    {
        ...
        function (bridge)
        {
            ...
            var solution = new SimpleSolution(',', replacement, SolutionType.OBJECT);
                    ...
                    if (optimizeComplex)
                    {
                        ...
                        for (var complex in COMPLEX)
                        {
                            ...
                            if (this.hasFeatures(entry.mask) && str.indexOf(complex) >= 0)
                            {
                                ...
                                (
                                    complexOptimizers[complex] =
                                    createComplexOptimizer$1(this, complex, entry.definition)
                                );
        ...
        (function ()
        {
            ...
            (
                { },
                {
                    ...
                    createComplexOptimizer:     createComplexOptimizer$1,
