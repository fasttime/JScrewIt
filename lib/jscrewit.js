// JScrewIt 2.28.0 – https://jscrew.it
...
(function () {
    ...
    function callWithFeatures()
    {
        ...
        _Array_prototype_push_apply(defineFnArgs, features);
    ...
    {
        var array = _Array_prototype_slice_call(args, startIndex, endIndex);
        return array;
    }

    makeCallableWithFeatures(define);

    function codePointFromSurrogatePair(highSurrogateCharCode, lowSurrogateCharCode)
    {
    ...
    function createSurrogatePairOptimizer (encoder)
    {
