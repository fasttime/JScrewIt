...
(function (self)
{
    ...
    Encoder.prototype =
    {
        ...
        encode: function (input, wrapWithEval)
        {
            ...
            var MIN_DICT_4_ENCODABLE_LENGTH = 185;
            ...
            if (input.length >= MIN_DICT_4_ENCODABLE_LENGTH)
            {
                var output4 = this.encodeByDict(input, 4);
                if (!output || output4 && output4.length < output.length)
                {
                    output = output4;
                }
            }
