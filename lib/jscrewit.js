...
(function ()
{
    ...
    ({
        ...
        FH_SHIFT_2:
        [
            define('[true + !!(+(ANY_FUNCTION + [])[0] + true)]')
        ],
    ...
    [
        ...
        define(undefined, 'CAPITAL_HTML', 'ENTRIES_OBJ'),
        define(createParseIntArgByReduce, 'CAPITAL_HTML', 'ENTRIES_PLAIN', 'FILL'),
        define(undefined, 'CAPITAL_HTML', 'ENTRIES_PLAIN', 'FILL', 'NO_IE_SRC'),
