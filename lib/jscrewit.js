// JScrewIt 2.24.0 – https://jscrew.it
...
(function () {
    ...
    // quinquaginta-duo 2.0.0 – https://github.com/fasttime/JScrewIt/tree/master/packages/quinquaginta-duo
    ...
    var createIndex = Object.create.bind(null, null, undefined);
    var keyFor = function (mask) { return "_" + mask; };
    var setEntry = function (map, mask, value) {
        var key = keyFor(mask);
        map[key] = value;
    };
    /** A data structure that maps masks to arbitrary values. */
    var MaskMap = /** @class */ (function () {
        function MaskMap() {
    ...
    var MaskSet = /** @class */ (function () {
        ...
        MaskSet.prototype.has = function (mask) {
            var key = keyFor(mask);
    ...
    // novem 1.2.1 – https://github.com/fasttime/JScrewIt/tree/master/packages/novem
    ...
    var calculateSolutionType = function (replacement) {
        var value = evalExpr(replacement);
    ...
    var isWeak = function (replacement, value) { return "" + value !== tryEvalExpr("\"\"+" + replacement); };
        ...
        if (!paddingEntries)
        {
            ...
            case 34:
                ...
                [
                    ...
                    define({ block: 'FBP_9_U', index: 43 }, NO_FF_SRC),
                    define({ block: 'RP_1_WA + FBP_5_S', index: 40 }, INCR_CHAR, NO_FF_SRC),
    ...
    function initReplaceStaticExpr(value)
    {
    ...
    function parsePrimaryExpr(parseInfo)
    {
        ...
        if (constValueExpr)
        {
            var constValue = evalExpr$1(constValueExpr);
    ...
    function replaceStaticExpr$1(expr)
    {
    ...
    (function ()
    {
        ...
        initReplaceStaticExpr(replaceStaticExpr$1);
    }
    )();
