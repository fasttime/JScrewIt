// JScrewIt 2.14.1 – https://jscrew.it
...
(function () {
    ...
    // novem 0.1.0 – https://github.com/fasttime/novem
    ...
    var isPrefixed$1 = makeIsAttr(SolutionType.PREFIXED_STRING, SolutionType.WEAK_PREFIXED_STRING);
    var isString = makeIsAttr(SolutionType.STRING, SolutionType.PREFIXED_STRING, SolutionType.WEAK_PREFIXED_STRING);
    ...
    var AbstractSolution = /** @class */ (function () {
        ...
        Object.defineProperty(AbstractSolution.prototype, "isPrefixed", {
            get: function () {
                return isPrefixed$1(this.type);
            },
            enumerable: false,
            configurable: true
        });
    ...
    function calculateReplacement(solutions) {
        switch (solutions.length) {
            ...
            default:
                {
                    var _a = findRule(solutions), typeSet = _a.typeSet, replace = _a.replace;
                    var typeSetCount = typeSet.length;
                    var replacements = solutions.slice(0, typeSetCount).map(getReplacement);
                    var replacement = replace.apply(void 0, replacements) +
                        solutions.slice(typeSetCount).map(function (_a) {
    ...
    function findRule(solutions) {
        var rule = RULES.find(function (_a) {
            var typeSet = _a.typeSet;
            return includesTypeSet(typeSet, solutions);
        });
        return rule;
    }
    ...
    function Solution(source, replacement, type)
    {
