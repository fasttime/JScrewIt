...
(function (self)
{
    ...
    function ScrewBuffer(strongBound, groupThreshold)
    {
        var head = '';
        var tail = '';
        var lastSolution;
                ...
                'length':
                {
                    get: function ()
                    {
                        ...
                        if (head)
                        {
                            ...
                            {
                                length +=
                                    lastSolution.length + (hasOuterPlus(lastSolution) ? 3 : 1);
                            }
                        }
                        else
                        {
    ...
    Encoder.prototype =
    {
        ...
        encodeByDict: function (input)
        {
            ...
            {
                var output =
                    freqIndexes + this.replace('["map"]') + '(' +
                    this.replace('""["charAt"]["bind"]') + '(' +
        ...
        // memory layout of the stack changes at runtime in an unstable way, the safe value cannot
        // be determined exactly.
        // The lowest reliably recorded value so far was 1844, measured in an Android Browser 4.2.2
        // on Intel Atom.
