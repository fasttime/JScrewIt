...
(function (self)
{
    ...
    Encoder.prototype =
    {
        ...
        {
            var functionConst = this.resolveConstant('Function');
            var subencoding =
            ...
            var subencOutput =
                ...
                this.resolveString(subencoding, true) +
                this.replace('["split"](false)') + '+' +
                this.resolveString(')') + ')()';
            var output = this.resolveString(input, false, subencOutput.length) || subencOutput;
            if (wrapWithEval)
            {
                output = functionConst + '(' + output + ')()';
            }
            return output;
        },
