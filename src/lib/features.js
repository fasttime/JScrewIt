...
var featureInfos =
{
    ...
    LOCALE_NUMERALS_IE11_WIN7_8:
    {
        ...
        'in the Japanese string representation of Infinity ("+∞"), the characters in the ' +
        'Japanese string representation of NaN ("NaN\xa0(非数値)"), the letters in the Lithuanian ' +
        'string representation of Infinity ("begalybė"), the letters in the Polish string ' +
        'representation of Infinity ("+nieskończoność"), the characters in the Chinese string ' +
        'representation of Infinity ("正无穷大" or "正無窮大"), the characters in the Simplified ' +
        'Chinese string representation of NaN ("非数字").',
        check:
        function ()
        {
            var available =
