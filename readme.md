...
These are covered in detail in the [relative section](doc/interfaces/encodeoptions.md) in the API
reference.
...
We do this using the feature [`BROWSER`](doc/interfaces/featureall.md#BROWSER):
...
Here we have used another feature: [`FF`](doc/interfaces/featureall.md#FF).
...
Specifically, [`ATOB`](doc/interfaces/featureall.md#ATOB) indicates native support for the functions
`atob` and `btoa`, while [`WINDOW`](doc/interfaces/featureall.md#WINDOW) refers to a particular
string representation of the global object `self`, where available.
...
[`JScrewIt.Feature.commonOf`](doc/interfaces/featureconstructor.md#commonof).

```js
{ features: JScrewIt.Feature.commonOf("ANDRO_4_4", "NODE_10", "SAFARI_7_0") }
```

The features turn out to be [`ESC_HTML_QUOT`](doc/interfaces/featureall.md#ESC_HTML_QUOT),
[`GMT`](doc/interfaces/featureall.md#GMT), [`INCR_CHAR`](doc/interfaces/featureall.md#INCR_CHAR),
[`NAME`](doc/interfaces/featureall.md#NAME), [`NO_IE_SRC`](doc/interfaces/featureall.md#NO_IE_SRC)
and [`UNDEFINED`](doc/interfaces/featureall.md#UNDEFINED) (a quick way to see this is entering
`JScrewIt.Feature.commonOf("ANDRO_4_4", "NODE_10", "SAFARI_7_0").toString()` in the browser's
console).
