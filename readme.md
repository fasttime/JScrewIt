...
These are covered in detail in the [relative section](api-doc/README.md#encodeoptions) in the API
Reference.
...
We do this using the feature [`BROWSER`](api-doc/README.md#BROWSER):
...
Here we have used another feature: [`FF`](api-doc/README.md#FF).
...
Specifically, [`ATOB`](api-doc/README.md#ATOB) indicates native support for the functions `atob` and
`btoa`, while [`WINDOW`](api-doc/README.md#WINDOW)refers to a particular string representation of
the global object `self`, where available.
...
These features can be retrieved with [`JScrewIt.Feature.commonOf`](api-doc/README.md#commonof).

```js
{ features: JScrewIt.Feature.commonOf("ANDRO_4_4", "NODE_10", "SAFARI_7_0") }
```

The features turn out to be [`ESC_HTML_QUOT`](api-doc/README.md#ESC_HTML_QUOT),
[`GMT`](api-doc/README.md#GMT), [`INCR_CHAR`](api-doc/README.md#INCR_CHAR),
[`NAME`](api-doc/README.md#NAME), [`NO_IE_SRC`](api-doc/README.md#NO_IE_SRC) and
[`UNDEFINED`](api-doc/README.md#UNDEFINED) (a quick way to see this is entering
