...
These are covered in the relative section in the
[API Reference](doc/interfaces/_encode_d_.encodeoptions.md).
...
We do this using the feature [`BROWSER`](doc/interfaces/_feature_d_.featureconstructor.md#BROWSER):
...
Here we have used another feature: [`FF`](doc/interfaces/_feature_d_.featureconstructor.md#FF).
...
Specifically, [`ATOB`](doc/interfaces/_feature_d_.featureconstructor.md#ATOB) indicates native
support for the functions `atob` and `btoa`, while
[`WINDOW`](doc/interfaces/_feature_d_.featureconstructor.md#WINDOW) refers to a particular string
...
[`JScrewIt.Feature.commonOf`](doc/interfaces/_feature_d_.featureconstructor.md#commonof).
...
[`ESC_HTML_QUOT`](doc/interfaces/_feature_d_.featureconstructor.md#ESC_HTML_QUOT),
[`GMT`](doc/interfaces/_feature_d_.featureconstructor.md#GMT),
[`INCR_CHAR`](doc/interfaces/_feature_d_.featureconstructor.md#INCR_CHAR),
[`NAME`](doc/interfaces/_feature_d_.featureconstructor.md#NAME),
[`NO_IE_SRC`](doc/interfaces/_feature_d_.featureconstructor.md#NO_IE_SRC) and
[`UNDEFINED`](doc/interfaces/_feature_d_.featureconstructor.md#UNDEFINED) (a quick way to see this
is entering `JScrewIt.Feature.commonOf("ANDRO_4_4", "NODE_10", "SAFARI_7_0").toString()` in the
browser's console).
